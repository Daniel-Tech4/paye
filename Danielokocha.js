// Defining the function "tests",that takes two arguments i.e test1 and test2.
...
// Defining the function "coursework",that takes an argument i.e cswork.
...
// Defining the function "crsmark" with the local argument "a".
function crsmark(a)
{
// Multiplying the operands avg(2) and (a/100) which is assigned to the initalized variable exm.
return exm 
let exm = avg(2)*(a/100) 
}
// Defining the function exam that takes an argument "a"
function exam(a)
{
   // Initialize variable fexam,multipply an operand (60/100) with an argument "a" from function exam.
let fexam = (60/100)*a 
return fexam
...
// function call of function named "fnal"
fnal()